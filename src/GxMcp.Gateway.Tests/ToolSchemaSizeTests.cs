...
namespace GxMcp.Gateway.Tests
{
    public class ToolSchemaSizeTests
    {
        ...
        public void TotalToolSchemaSizeIsUnderBudget()
        {
            ...
            //   2026-07-19 (add_index): added 'add_index' action + 'attributeName'
            //   param to genexus_structure. Measured ~14586 tokens; budget 14800.
            Assert.True(approxTokens < 14800, $"tool_definitions.json is ~{approxTokens} tokens; budget 14800.");
        }
    }
}
